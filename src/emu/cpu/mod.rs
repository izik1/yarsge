...
impl Cpu {
    ...
    fn run_instruction(&mut self) {
        ...
        match op {
            ...
            0x20 => instr::jr(self, !self.regs.f.contains(Flag::Z)),
            ...
            0x27 => instr::daa(self),
            0x28 => instr::jr(self, self.regs.f.contains(Flag::Z)),
            ...
            0x2F => instr::cpl(self),
            0x30 => instr::jr(self, !self.regs.f.contains(Flag::C)),
            ...
            0x37 => instr::scf(self),
            0x38 => instr::jr(self, self.regs.f.contains(Flag::C)),
            ...
            0xC0 => instr::retc(self, !self.regs.f.contains(Flag::Z)),
            0xC1 => instr::pop(self, R16::BC),
            0xC2 => instr::jp(self, !self.regs.f.contains(Flag::Z)),
            0xC3 => instr::jp(self, true),
            0xC4 => instr::call(self, !self.regs.f.contains(Flag::Z)),
            0xC5 => instr::push(self, R16::BC),
            0xC6 => instr::add(self, MathReg::Imm),
            0xC7 => instr::rst(self, 0x00),
            0xC8 => instr::retc(self, self.regs.f.contains(Flag::Z)),
            0xC9 => instr::ret(self, false),
            0xCA => instr::jp(self, self.regs.f.contains(Flag::Z)),
            0xCB => self.run_extended(),
            0xCC => instr::call(self, self.regs.f.contains(Flag::Z)),
            ...
            0xD8 => instr::retc(self, self.regs.f.contains(Flag::C)),
            0xD9 => instr::ret(self, true),
            0xDA => instr::jp(self, self.regs.f.contains(Flag::C)),
            0xDC => instr::call(self, self.regs.f.contains(Flag::C)),
